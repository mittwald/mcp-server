...
- **FR-011**: Baseline comparison report MUST include before/after metrics for: tool call counts, retry frequencies, success/failure rates, domain-specific breakdowns, and variance analysis explaining differences between old (prescriptive prompts) and new (outcome-focused prompts) baselines
