# CLI Migration Agent 16 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-16`
- **Branch**: `cli-v2-agent-16`
- **Registry**: `swarm-v2/registry/agent-16-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_org_membership_list**\n   - Command: `mw org/membership/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-membership-list.md`\n\n2. **mittwald_org_membership_revoke**\n   - Command: `mw org/membership/revoke`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-membership-revoke.md`\n\n3. **mittwald_org_membership**\n   - Command: `mw org/membership`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-membership.md`\n\n4. **mittwald_org**\n   - Command: `mw org`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org.md`\n\n5. **mittwald_project_filesystem**\n   - Command: `mw project/filesystem`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-filesystem.md`\n\n6. **mittwald_project_invite_list_own**\n   - Command: `mw project/invite/list/own`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-invite-list-own.md`\n\n7. **mittwald_project_invite_list**\n   - Command: `mw project/invite/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-invite-list.md`\n\n
...
git add swarm-v2/registry/agent-16-registry.csv progress.log
...
git push origin cli-v2-agent-16
```
