# CLI Migration Agent 11 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-11`
- **Branch**: `cli-v2-agent-11`
- **Registry**: `swarm-v2/registry/agent-11-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_ddev_init**\n   - Command: `mw ddev/init`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ddev-init.md`\n\n2. **mittwald_ddev_render_config**\n   - Command: `mw ddev/render/config`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ddev-render-config.md`\n\n3. **mittwald_ddev**\n   - Command: `mw ddev`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ddev.md`\n\n4. **mittwald_domain_dnszone_get**\n   - Command: `mw domain/dnszone/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-dnszone-get.md`\n\n5. **mittwald_domain_dnszone_list**\n   - Command: `mw domain/dnszone/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-dnszone-list.md`\n\n6. **mittwald_domain_dnszone_update**\n   - Command: `mw domain/dnszone/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-dnszone-update.md`\n\n7. **mittwald_domain_dnszone**\n   - Command: `mw domain/dnszone`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-dnszone.md`\n\n8. **mittwald_domain_get**\n   - Command: `mw domain/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-get.md`\n\n
...
git add swarm-v2/registry/agent-11-registry.csv progress.log
...
git push origin cli-v2-agent-11
```
