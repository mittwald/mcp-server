# CLI Migration Agent 7 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-7`
- **Branch**: `cli-v2-agent-7`
- **Registry**: `swarm-v2/registry/agent-7-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_cronjob_create**\n   - Command: `mw cronjob/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-create.md`\n\n2. **mittwald_cronjob_delete**\n   - Command: `mw cronjob/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-delete.md`\n\n3. **mittwald_cronjob_execute**\n   - Command: `mw cronjob/execute`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-execute.md`\n\n4. **mittwald_cronjob_execution_abort**\n   - Command: `mw cronjob/execution/abort`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-execution-abort.md`\n\n5. **mittwald_cronjob_execution_get**\n   - Command: `mw cronjob/execution/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-execution-get.md`\n\n6. **mittwald_cronjob_execution_list**\n   - Command: `mw cronjob/execution/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-execution-list.md`\n\n7. **mittwald_cronjob_execution_logs**\n   - Command: `mw cronjob/execution/logs`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-execution-logs.md`\n\n8. **mittwald_cronjob_execution**\n   - Command: `mw cronjob/execution`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-cronjob-execution.md`\n\n
...
git add swarm-v2/registry/agent-7-registry.csv progress.log
...
git push origin cli-v2-agent-7
```
