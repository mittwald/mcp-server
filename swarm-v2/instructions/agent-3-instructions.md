# CLI Migration Agent 3 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-3`
- **Branch**: `cli-v2-agent-3`
- **Registry**: `swarm-v2/registry/agent-3-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_app_list**\n   - Command: `mw app/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-list.md`\n\n2. **mittwald_app_open**\n   - Command: `mw app/open`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-open.md`\n\n3. **mittwald_app_ssh**\n   - Command: `mw app/ssh`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-ssh.md`\n\n4. **mittwald_app_uninstall**\n   - Command: `mw app/uninstall`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-uninstall.md`\n\n5. **mittwald_app_update**\n   - Command: `mw app/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-update.md`\n\n6. **mittwald_app_upgrade**\n   - Command: `mw app/upgrade`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-upgrade.md`\n\n7. **mittwald_app_upload**\n   - Command: `mw app/upload`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-upload.md`\n\n8. **mittwald_app_versions**\n   - Command: `mw app/versions`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-versions.md`\n\n
...
git add swarm-v2/registry/agent-3-registry.csv progress.log
...
git push origin cli-v2-agent-3
```
