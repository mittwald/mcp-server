# CLI Migration Agent 17 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-17`
- **Branch**: `cli-v2-agent-17`
- **Registry**: `swarm-v2/registry/agent-17-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_project_invite**\n   - Command: `mw project/invite`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-invite.md`\n\n2. **mittwald_project_list**\n   - Command: `mw project/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-list.md`\n\n3. **mittwald_project_membership_get_own**\n   - Command: `mw project/membership/get/own`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-membership-get-own.md`\n\n4. **mittwald_project_membership_get**\n   - Command: `mw project/membership/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-membership-get.md`\n\n5. **mittwald_project_membership_list_own**\n   - Command: `mw project/membership/list/own`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-membership-list-own.md`\n\n6. **mittwald_project_membership_list**\n   - Command: `mw project/membership/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-membership-list.md`\n\n7. **mittwald_project_membership**\n   - Command: `mw project/membership`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-membership.md`\n\n
...
git add swarm-v2/registry/agent-17-registry.csv progress.log
...
git push origin cli-v2-agent-17
```
