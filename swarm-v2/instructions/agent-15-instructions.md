# CLI Migration Agent 15 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-15`
- **Branch**: `cli-v2-agent-15`
- **Registry**: `swarm-v2/registry/agent-15-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_mail_deliverybox**\n   - Command: `mw mail/deliverybox`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-deliverybox.md`\n\n2. **mittwald_mail**\n   - Command: `mw mail`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail.md`\n\n3. **mittwald_org_delete**\n   - Command: `mw org/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-delete.md`\n\n4. **mittwald_org_get**\n   - Command: `mw org/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-get.md`\n\n5. **mittwald_org_invite**\n   - Command: `mw org/invite`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-invite.md`\n\n6. **mittwald_org_list**\n   - Command: `mw org/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-list.md`\n\n7. **mittwald_org_membership_list_own**\n   - Command: `mw org/membership/list/own`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-org-membership-list-own.md`\n\n
...
git add swarm-v2/registry/agent-15-registry.csv progress.log
...
git push origin cli-v2-agent-15
```
