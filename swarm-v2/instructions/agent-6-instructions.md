# CLI Migration Agent 6 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-6`
- **Branch**: `cli-v2-agent-6`
- **Registry**: `swarm-v2/registry/agent-6-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_contributor**\n   - Command: `mw contributor`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-contributor.md`\n\n2. **mittwald_conversation_categories**\n   - Command: `mw conversation/categories`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation-categories.md`\n\n3. **mittwald_conversation_close**\n   - Command: `mw conversation/close`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation-close.md`\n\n4. **mittwald_conversation_create**\n   - Command: `mw conversation/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation-create.md`\n\n5. **mittwald_conversation_list**\n   - Command: `mw conversation/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation-list.md`\n\n6. **mittwald_conversation_reply**\n   - Command: `mw conversation/reply`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation-reply.md`\n\n7. **mittwald_conversation_show**\n   - Command: `mw conversation/show`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation-show.md`\n\n8. **mittwald_conversation**\n   - Command: `mw conversation`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-conversation.md`\n\n
...
git add swarm-v2/registry/agent-6-registry.csv progress.log
...
git push origin cli-v2-agent-6
```
