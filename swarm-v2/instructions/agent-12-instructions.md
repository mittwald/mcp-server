# CLI Migration Agent 12 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-12`
- **Branch**: `cli-v2-agent-12`
- **Registry**: `swarm-v2/registry/agent-12-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_domain_list**\n   - Command: `mw domain/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-list.md`\n\n2. **mittwald_domain_virtualhost_create**\n   - Command: `mw domain/virtualhost/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-virtualhost-create.md`\n\n3. **mittwald_domain_virtualhost_delete**\n   - Command: `mw domain/virtualhost/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-virtualhost-delete.md`\n\n4. **mittwald_domain_virtualhost_get**\n   - Command: `mw domain/virtualhost/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-virtualhost-get.md`\n\n5. **mittwald_domain_virtualhost**\n   - Command: `mw domain/virtualhost`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain-virtualhost.md`\n\n6. **mittwald_domain**\n   - Command: `mw domain`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-domain.md`\n\n7. **mittwald_extension**\n   - Command: `mw extension`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-extension.md`\n\n
...
git add swarm-v2/registry/agent-12-registry.csv progress.log
...
git push origin cli-v2-agent-12
```
