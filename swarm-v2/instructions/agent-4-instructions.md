# CLI Migration Agent 4 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-4`
- **Branch**: `cli-v2-agent-4`
- **Registry**: `swarm-v2/registry/agent-4-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_app**\n   - Command: `mw app`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app.md`\n\n2. **mittwald_backup_create**\n   - Command: `mw backup/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-create.md`\n\n3. **mittwald_backup_delete**\n   - Command: `mw backup/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-delete.md`\n\n4. **mittwald_backup_download**\n   - Command: `mw backup/download`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-download.md`\n\n5. **mittwald_backup_get**\n   - Command: `mw backup/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-get.md`\n\n6. **mittwald_backup_list**\n   - Command: `mw backup/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-list.md`\n\n7. **mittwald_backup_schedule_create**\n   - Command: `mw backup/schedule/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-schedule-create.md`\n\n8. **mittwald_backup_schedule_delete**\n   - Command: `mw backup/schedule/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-schedule-delete.md`\n\n
...
git add swarm-v2/registry/agent-4-registry.csv progress.log
...
git push origin cli-v2-agent-4
```
