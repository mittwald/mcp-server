# CLI Migration Agent 18 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-18`
- **Branch**: `cli-v2-agent-18`
- **Registry**: `swarm-v2/registry/agent-18-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_project_ssh**\n   - Command: `mw project/ssh`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-ssh.md`\n\n2. **mittwald_project_update**\n   - Command: `mw project/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project-update.md`\n\n3. **mittwald_project**\n   - Command: `mw project`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-project.md`\n\n4. **mittwald_server_get**\n   - Command: `mw server/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-server-get.md`\n\n5. **mittwald_server_list**\n   - Command: `mw server/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-server-list.md`\n\n6. **mittwald_server**\n   - Command: `mw server`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-server.md`\n\n7. **mittwald_sftp_user_create**\n   - Command: `mw sftp/user/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-sftp-user-create.md`\n\n
...
git add swarm-v2/registry/agent-18-registry.csv progress.log
...
git push origin cli-v2-agent-18
```
