# CLI Migration Agent 1 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-1`
- **Branch**: `cli-v2-agent-1`
- **Registry**: `swarm-v2/registry/agent-1-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_app_copy**\n   - Command: `mw app/copy`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-copy.md`\n\n2. **mittwald_app_create_node**\n   - Command: `mw app/create/node`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-create-node.md`\n\n3. **mittwald_app_create_php_worker**\n   - Command: `mw app/create/php/worker`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-create-php-worker.md`\n\n4. **mittwald_app_create_php**\n   - Command: `mw app/create/php`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-create-php.md`\n\n5. **mittwald_app_create_python**\n   - Command: `mw app/create/python`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-create-python.md`\n\n6. **mittwald_app_create_static**\n   - Command: `mw app/create/static`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-create-static.md`\n\n7. **mittwald_app_create**\n   - Command: `mw app/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-create.md`\n\n8. **mittwald_app_dependency_list**\n   - Command: `mw app/dependency/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-dependency-list.md`\n\n
...
git add swarm-v2/registry/agent-1-registry.csv progress.log
...
git push origin cli-v2-agent-1
```
