# CLI Migration Agent 2 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-2`
- **Branch**: `cli-v2-agent-2`
- **Registry**: `swarm-v2/registry/agent-2-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_app_dependency_update**\n   - Command: `mw app/dependency/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-dependency-update.md`\n\n2. **mittwald_app_dependency_versions**\n   - Command: `mw app/dependency/versions`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-dependency-versions.md`\n\n3. **mittwald_app_dependency**\n   - Command: `mw app/dependency`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-dependency.md`\n\n4. **mittwald_app_download**\n   - Command: `mw app/download`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-download.md`\n\n5. **mittwald_app_get**\n   - Command: `mw app/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-get.md`\n\n6. **mittwald_app_install_contao**\n   - Command: `mw app/install/contao`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-install-contao.md`\n\n7. **mittwald_app_install**\n   - Command: `mw app/install`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-install.md`\n\n8. **mittwald_app_list_upgrade_candidates**\n   - Command: `mw app/list/upgrade/candidates`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-app-list-upgrade-candidates.md`\n\n
...
git add swarm-v2/registry/agent-2-registry.csv progress.log
...
git push origin cli-v2-agent-2
```
