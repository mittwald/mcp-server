# CLI Migration Agent 10 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-10`
- **Branch**: `cli-v2-agent-10`
- **Registry**: `swarm-v2/registry/agent-10-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_database_mysql**\n   - Command: `mw database/mysql`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-mysql.md`\n\n2. **mittwald_database_redis_create**\n   - Command: `mw database/redis/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-redis-create.md`\n\n3. **mittwald_database_redis_get**\n   - Command: `mw database/redis/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-redis-get.md`\n\n4. **mittwald_database_redis_list**\n   - Command: `mw database/redis/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-redis-list.md`\n\n5. **mittwald_database_redis_shell**\n   - Command: `mw database/redis/shell`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-redis-shell.md`\n\n6. **mittwald_database_redis_versions**\n   - Command: `mw database/redis/versions`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-redis-versions.md`\n\n7. **mittwald_database_redis**\n   - Command: `mw database/redis`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database-redis.md`\n\n8. **mittwald_database**\n   - Command: `mw database`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-database.md`\n\n
...
git add swarm-v2/registry/agent-10-registry.csv progress.log
...
git push origin cli-v2-agent-10
```
