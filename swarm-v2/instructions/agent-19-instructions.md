# CLI Migration Agent 19 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-19`
- **Branch**: `cli-v2-agent-19`
- **Registry**: `swarm-v2/registry/agent-19-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_sftp_user_delete**\n   - Command: `mw sftp/user/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-sftp-user-delete.md`\n\n2. **mittwald_sftp_user_list**\n   - Command: `mw sftp/user/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-sftp-user-list.md`\n\n3. **mittwald_sftp_user_update**\n   - Command: `mw sftp/user/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-sftp-user-update.md`\n\n4. **mittwald_sftp_user**\n   - Command: `mw sftp/user`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-sftp-user.md`\n\n5. **mittwald_ssh_user_create**\n   - Command: `mw ssh/user/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ssh-user-create.md`\n\n6. **mittwald_ssh_user_delete**\n   - Command: `mw ssh/user/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ssh-user-delete.md`\n\n7. **mittwald_ssh_user_list**\n   - Command: `mw ssh/user/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ssh-user-list.md`\n\n
...
git add swarm-v2/registry/agent-19-registry.csv progress.log
...
git push origin cli-v2-agent-19
```
