# CLI Migration Agent 14 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-14`
- **Branch**: `cli-v2-agent-14`
- **Registry**: `swarm-v2/registry/agent-14-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_mail_address_update**\n   - Command: `mw mail/address/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-address-update.md`\n\n2. **mittwald_mail_address**\n   - Command: `mw mail/address`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-address.md`\n\n3. **mittwald_mail_deliverybox_create**\n   - Command: `mw mail/deliverybox/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-deliverybox-create.md`\n\n4. **mittwald_mail_deliverybox_delete**\n   - Command: `mw mail/deliverybox/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-deliverybox-delete.md`\n\n5. **mittwald_mail_deliverybox_get**\n   - Command: `mw mail/deliverybox/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-deliverybox-get.md`\n\n6. **mittwald_mail_deliverybox_list**\n   - Command: `mw mail/deliverybox/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-deliverybox-list.md`\n\n7. **mittwald_mail_deliverybox_update**\n   - Command: `mw mail/deliverybox/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-deliverybox-update.md`\n\n
...
git add swarm-v2/registry/agent-14-registry.csv progress.log
...
git push origin cli-v2-agent-14
```
