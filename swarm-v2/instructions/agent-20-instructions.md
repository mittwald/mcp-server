# CLI Migration Agent 20 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-20`
- **Branch**: `cli-v2-agent-20`
- **Registry**: `swarm-v2/registry/agent-20-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_ssh_user_update**\n   - Command: `mw ssh/user/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ssh-user-update.md`\n\n2. **mittwald_ssh_user**\n   - Command: `mw ssh/user`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-ssh-user.md`\n\n3. **mittwald_user_api_token_create**\n   - Command: `mw user/api/token/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-user-api-token-create.md`\n\n4. **mittwald_user_api_token_get**\n   - Command: `mw user/api/token/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-user-api-token-get.md`\n\n5. **mittwald_user_api_token**\n   - Command: `mw user/api/token`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-user-api-token.md`\n\n6. **mittwald_user_get**\n   - Command: `mw user/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-user-get.md`\n\n7. **mittwald_user**\n   - Command: `mw user`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-user.md`\n\n
...
git add swarm-v2/registry/agent-20-registry.csv progress.log
...
git push origin cli-v2-agent-20
```
