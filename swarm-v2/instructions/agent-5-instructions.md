# CLI Migration Agent 5 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-5`
- **Branch**: `cli-v2-agent-5`
- **Registry**: `swarm-v2/registry/agent-5-registry.csv`

## Your Assigned Tools
You have been assigned 8 tools to implement:\n\n1. **mittwald_backup_schedule_list**\n   - Command: `mw backup/schedule/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-schedule-list.md`\n\n2. **mittwald_backup_schedule_update**\n   - Command: `mw backup/schedule/update`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-schedule-update.md`\n\n3. **mittwald_backup_schedule**\n   - Command: `mw backup/schedule`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup-schedule.md`\n\n4. **mittwald_backup**\n   - Command: `mw backup`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-backup.md`\n\n5. **mittwald_context_get**\n   - Command: `mw context/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-context-get.md`\n\n6. **mittwald_context_reset**\n   - Command: `mw context/reset`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-context-reset.md`\n\n7. **mittwald_context_set**\n   - Command: `mw context/set`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-context-set.md`\n\n8. **mittwald_context**\n   - Command: `mw context`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-context.md`\n\n
...
git add swarm-v2/registry/agent-5-registry.csv progress.log
...
git push origin cli-v2-agent-5
```
