# CLI Migration Agent 13 Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-13`
- **Branch**: `cli-v2-agent-13`
- **Registry**: `swarm-v2/registry/agent-13-registry.csv`

## Your Assigned Tools
You have been assigned 7 tools to implement:\n\n1. **mittwald_login_status**\n   - Command: `mw login/status`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-login-status.md`\n\n2. **mittwald_login_token**\n   - Command: `mw login/token`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-login-token.md`\n\n3. **mittwald_login**\n   - Command: `mw login`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-login.md`\n\n4. **mittwald_mail_address_create**\n   - Command: `mw mail/address/create`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-address-create.md`\n\n5. **mittwald_mail_address_delete**\n   - Command: `mw mail/address/delete`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-address-delete.md`\n\n6. **mittwald_mail_address_get**\n   - Command: `mw mail/address/get`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-address-get.md`\n\n7. **mittwald_mail_address_list**\n   - Command: `mw mail/address/list`\n   - CLI File: `/Users/robert/Code/Mittwald/cli-commands/mw-mail-address-list.md`\n\n
...
git add swarm-v2/registry/agent-13-registry.csv progress.log
...
git push origin cli-v2-agent-13
```
