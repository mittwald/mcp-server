...
sidebar:
  label: Install Matomo
  order: 109
head:
  - tag: meta
    attrs:
      name: og:title
      content: Install Matomo
  - tag: meta
    attrs:
      name: og:description
      content: Install Matomo application.
lastUpdated: 2026-01-23
---
## Overview

Install Matomo application.
...
| `version` | `string` | No | Matomo version to install (defaults to latest if not specified) |
...
| `siteTitle` | `string` | No | Title for the Matomo installation |
