...
sidebar:
  label: Install Shopware 5
  order: 109
head:
  - tag: meta
    attrs:
      name: og:title
      content: Install Shopware 5
  - tag: meta
    attrs:
      name: og:description
      content: Install Shopware 5 application.
lastUpdated: 2026-01-23
---
## Overview

Install Shopware 5 application.
...
| `version` | `string` | No | Shopware 5 version to install (defaults to latest if not specified) |
...
| `siteTitle` | `string` | No | Title for the Shopware 5 installation |
