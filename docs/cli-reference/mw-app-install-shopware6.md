...
```
$ mw app install shopware6 --help
Creates new Shopware 6 installation.

USAGE
  $ mw app install shopware6 --version <value> [-p <value>] [-q] [--host <value>]
...
FLAGS
  ...
  -w, --wait                     wait for the resource to be ready.
      ...
      --host=<value>             host to initially configure your Shopware 6
                                 installation with; needs to be created
                                 separately.
      --shop-currency=<value>    Currency your Shopware 6 will be working with.
      --shop-email=<value>       email address your Shopware 6 will be working
                                 with.
...
FLAG DESCRIPTIONS
  ...
  --admin-email=<value>  email address of your administrator user.
    ...
    created during the Shopware 6 installation.
  ...
  --host=<value>
    ...
    host to initially configure your Shopware 6 installation with; needs to be
    created separately.

    Specify a host which will be used during the installation and as an initial
    host for the Shopware 6 configuration.
    ...
    configuring the host and your Shopware 6 installation.

  --shop-currency=<value>  Currency your Shopware 6 will be working with.

    The default currency your Shopware 6 shop communicates prices and calculates
    transactions with.
  ...
  --shop-email=<value>  email address your Shopware 6 will be working with.
    ...
    The email address your Shopware 6 installation will be using for
  ...
  --shop-lang=<value>  language your Shopware 6 will be working with.
    ...
    The default language your Shopware 6 installation will be using. The front-
  ...
  --site-title=<value>  site title for your Shopware 6 installation.
    ...
    The site title for this Shopware 6 installation. It is also the title shown
  ...
  --version=<value>  version of Shopware 6 to be installed.
    ...
    If unspecified, the Shopware 6 will be installed in the latest available
    version.
