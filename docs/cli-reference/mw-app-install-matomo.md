...
```
$ mw app install matomo --help
Creates new Matomo installation.

USAGE
  $ mw app install matomo --version <value> [-p <value>] [-q] [--host <value>]
...
FLAGS
  ...
  -w, --wait                  wait for the resource to be ready.
      ...
      --host=<value>          host to initially configure your Matomo
                              installation with; needs to be created separately.
      --site-title=<value>    site title for your Matomo installation.
      --version=<value>       (required) [default: latest] version of Matomo to
                              be installed.
...
FLAG DESCRIPTIONS
  ...
  --admin-email=<value>  email address of your administrator user.
    ...
    created during the Matomo installation.
  ...
  --host=<value>
    ...
    host to initially configure your Matomo installation with; needs to be
    created separately.

    Specify a host which will be used during the installation and as an initial
    host for the Matomo configuration.
    ...
    configuring the host and your Matomo installation.

  --site-title=<value>  site title for your Matomo installation.

    The site title for this Matomo installation. It is also the title shown in
  ...
  --version=<value>  version of Matomo to be installed.
    ...
    If unspecified, the Matomo will be installed in the latest available
    version.
