...
```
$ mw app install joomla --help
Creates new Joomla! installation.

USAGE
  $ mw app install joomla --version <value> [-p <value>] [-q] [--host <value>]
...
FLAGS
  ...
  -w, --wait                     wait for the resource to be ready.
      ...
      --host=<value>             host to initially configure your Joomla!
                                 installation with; needs to be created
                                 separately.
      --site-title=<value>       site title for your Joomla! installation.
      --version=<value>          (required) [default: latest] version of Joomla!
                                 to be installed.
...
FLAG DESCRIPTIONS
  ...
  --admin-email=<value>  email address of your administrator user.
    ...
    created during the Joomla! installation.
  ...
  --host=<value>
    ...
    host to initially configure your Joomla! installation with; needs to be
    created separately.

    Specify a host which will be used during the installation and as an initial
    host for the Joomla! configuration.
    ...
    configuring the host and your Joomla! installation.

  --site-title=<value>  site title for your Joomla! installation.

    The site title for this Joomla! installation. It is also the title shown in
  ...
  --version=<value>  version of Joomla! to be installed.
    ...
    If unspecified, the Joomla! will be installed in the latest available
    version.
