...
- **VS Code 1.101 or later** (required for OAuth support)
...
If you do not see CodeLens buttons, restart VS Code and confirm your version is 1.101+.
...
2. Restart VS Code
3. Ensure you are on VS Code 1.101+ (`code --version`)
...
**Fix**:
1. Update VS Code to 1.101 or later
...
**A**: Use VS Code 1.101 or later for OAuth support.

### Q: Does this work with VS Code Insiders?
**A**: Yes, as long as your Insiders build is 1.101+.
...
- **[Explore All Tools](/reference/)**: Browse complete reference
- **[What is MCP?](/explainers/what-is-mcp/)**: Learn foundational concepts
- **[Case Studies](/case-studies/)**: See real-world examples
- **[Other Tools](/getting-started/)**: Set up Claude Code, Cursor, or Codex CLI
