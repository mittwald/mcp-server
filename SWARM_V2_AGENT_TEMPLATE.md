# CLI Migration Agent {NUMBER} Instructions
...
## Your Workspace
- **Directory**: `../mittwald-cli-swarm-v2/agent-{NUMBER}`
- **Branch**: `cli-v2-agent-{NUMBER}`
- **Registry**: `swarm-v2/registry/agent-{NUMBER}-registry.csv`
...
git add swarm-v2/registry/agent-{NUMBER}-registry.csv progress.log
...
git push origin cli-v2-agent-{NUMBER}
```
