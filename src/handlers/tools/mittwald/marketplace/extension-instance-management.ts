...
export const handleMittwaldExtensionInstanceCreate: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.createExtensionInstance({
      data: requestData
    });
...
export const handleMittwaldExtensionInstanceDelete: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.deleteExtensionInstance({
      extensionInstanceId
    });
...
export const handleMittwaldExtensionInstanceEnable: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.enableExtensionInstance({
      extensionInstanceId
    });
...
export const handleMittwaldExtensionInstanceDisable: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.disableExtensionInstance({
      extensionInstanceId
    });
...
export const handleMittwaldExtensionInstanceUpdateScopes: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.updateExtensionInstanceScopes({
      extensionInstanceId,
      data: { scopes }
    });
...
export const handleMittwaldExtensionInstanceCreateRetrievalKey: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.createAccessTokenRetrievalKey({
      extensionInstanceId
    });
...
export const handleMittwaldExtensionInstanceCreateToken: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.createExtensionInstanceToken({
      extensionInstanceId,
      data: requestData
    });
...
export const handleMittwaldExtensionInstanceUpdateSecret: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.updateExtensionInstanceSecret({
      contributorId,
      extensionId,
      extensionInstanceId,
      data: {
...
export const handleMittwaldExtensionInstanceAuthenticateSession: ToolHandler<{
  ...
  try {
    ...
    const response = await client.api.marketplace.authenticateExtensionInstanceSession({
      extensionInstanceId,
      sessionId,
      data: { sessionToken }
    });
