...
import { stopContainer, LibraryError } from '@mittwald-mcp/cli-core';
...
export const handleContainerStopCli: MittwaldCliToolHandler<MittwaldContainerStopArgs> = async (args, sessionId) => {
  ...
  try {
    ...
    logger.error('[WP05] Unexpected error in container stop handler', { error });
