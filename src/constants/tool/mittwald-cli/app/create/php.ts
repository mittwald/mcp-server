...
export const mittwald_app_create_php: Tool = {
  name: "mittwald_app_create_php",
  description: "Creates new custom PHP installation",
  inputSchema: {
    type: "object",
    properties: {
      projectId: {
      ...
      documentRoot: {
        type: "string",
        description: "Document root for PHP app serving (relative to installation path)",
        default: "/"
      },
      siteTitle: {
        type: "string",
        description: "Site title for your PHP installation"
      },
      quiet: {
        type: "boolean",
