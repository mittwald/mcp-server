...
import { handleAppCreatePhpCli } from '../../../../../handlers/tools/mittwald-cli/app/create/php-cli.js';

const tool: Tool = {
  name: 'mittwald_app_create_php',
  description: 'Create a PHP app using CLI',
  inputSchema: {
    type: 'object',
    properties: {
      projectId: {
...
export const mittwald_app_create_php_cli = tool;