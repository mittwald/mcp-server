...
export const mittwald_app_install_shopware5: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      version: {
        type: "string",
        description: "REQUIRED: Exact Shopware 5 version to install. You MUST first call mittwald_app_versions with app type 'shopware5' to get valid versions. Do NOT use 'latest' - choose the recommended version or a specific version from the list."
      },
      host: {
        type: "string",
